...
- **点击标记三级掌握**：点一下知识点循环标记「已学习 → 已操练 → 已掌握」（蓝 / 橙 / 绿），进度自动保存到浏览器；家长和老师一眼能看出孩子卡在哪一阶。
...
| 角色 | 使用方式 |
|------|---------|
| **学生** | 按模块逐一点亮状态：先标「已学习」，做过题后升到「已操练」，能独立限时做对再点「已掌握」。 |
| **家长** | 打开页面就能看到「已学习 / 已操练 / 已掌握」三档分布，知道孩子哪些模块还停留在「只看过」阶段，方便督促。 |
