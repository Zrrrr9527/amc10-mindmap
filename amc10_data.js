 ...
 * 数学公式使用 KaTeX 行内定界符 \( ... \)（JS 字符串中写作 \\( ... \\)）。
 * ⚠️ t 字段是 localStorage 进度键，勿改动，否则孩子已标记进度会失配。
 */
var MODULES = [
  {
    ...
    branches: [
      { title: "方程与不等式", leaves: [
        ...
        { t: "二次方程 / 韦达定理 Quadratic Equations / Vieta", lv: "mid", ex: "The roots of \\(x^2-5x+6\\) are \\(r\\) and \\(s\\). What is the value of \\((r-1)(s-1)\\)?", kw: "Vieta's formulas quadratic" },
        { t: "绝对值不等式 Absolute Value Inequalities", lv: "mid", ex: "How many integers \\(n\\) satisfy \\(|n-3| \\le 5\\)?", kw: "absolute value inequality integers" },
        { t: "分式与根式方程 Rational & Radical Equations", lv: "hard", ex: "If \\(\\dfrac{1}{x-1} + \\dfrac{1}{x+1} = \\dfrac{2}{x}\\), what is the positive solution for \\(x\\)?", kw: "rational equation" }
      ]},
      { title: "函数", leaves: [
      ...
      { title: "多项式", leaves: [
        { t: "因式定理 Factor Theorem", lv: "mid", ex: "If \\(x-2\\) is a factor of \\(x^3-3x^2+ax-2\\), what is \\(a\\)?", kw: "Factor Theorem" },
        { t: "余数定理 Remainder Theorem", lv: "mid", ex: "What is the remainder when \\(x^3 - 2x + 1\\) is divided by \\(x - 1\\)?", kw: "Remainder Theorem" },
        { t: "多项式因式分解 Polynomial Factorization", lv: "hard", ex: "Factor \\(x^4 - 16\\) completely over the reals.", kw: "polynomial factorization" },
        { t: "根与系数综合 Roots & Coefficients (Vieta)", lv: "hard", ex: "The cubic \\(x^3 - 6x^2 + 11x - 6\\) has roots \\(a, b, c\\). Find the product \\(abc\\).", kw: "roots of polynomial Vieta" },
        { t: "有理根定理 Rational Root Theorem", lv: "mid", ex: "List all possible rational roots of \\(2x^3 - x^2 - 5x + 2 = 0\\), then test to find one actual rational root.", kw: "Rational Root Theorem" }
      ]},
      { title: "解题技巧", leaves: [
        { t: "代入验证法 Guess-and-Check / Substitution", lv: "easy", ex: "Which of \\(0, 1, 2, 3\\) is a solution to \\(x^2 - 3x + 2 = 0\\)?", kw: "guess and check" },
        { t: "特殊值法 Plug-in Special Values", lv: "mid", ex: "\\((x+1)^2 - x^2\\) simplifies to which linear expression? Test \\(x=2\\) to check.", kw: "plug in values" },
        { t: "配方法 Completing the Square", lv: "mid", ex: "What number completes the square for \\(x^2 + 6x + \\underline{\\phantom{00}}\\) to make a perfect square?", kw: "completing the square" },
        { t: "对称与换元 Symmetry & Substitution", lv: "hard", ex: "If \\(a+b=5\\) and \\(ab=6\\), what is \\(a^2+b^2\\)?", kw: "symmetry substitution" }
      ]}
    ]
  },
  {
    ...
    branches: [
      ...
      { title: "立体几何", leaves: [
        { t: "柱/锥/球体积 Volumes of Prisms / Pyramids / Spheres", lv: "easy", ex: "A cylinder has radius \\(2\\) and height \\(3\\). What is its volume (in terms of \\(\\pi\\))?", kw: "cylinder volume" },
  ...
  },
  {
    ...
    branches: [
      ...
      { title: "整除与同余", leaves: [
        ...
        { t: "模运算 Modular Arithmetic", lv: "mid", ex: "What is \\(17 \\bmod 5\\)?", kw: "modular arithmetic" },
        { t: "同余方程 Congruences", lv: "hard", ex: "Find the remainder when \\(2^{10}\\) is divided by \\(3\\).", kw: "congruence" },
      ...
      { title: "数的表示", leaves: [
        { t: "进制转换 Base Conversion", lv: "mid", ex: "What is the decimal value of the binary number \\(1011_2\\)?", kw: "base conversion" },
        { t: "数字和与数位 Digit Sums & Positions", lv: "easy", ex: "What is the sum of the digits of \\(2^5 = 32\\)?", kw: "sum of digits" },
        { t: "数位综合问题 Digit-Based Problems", lv: "hard", ex: "What is the 1000th digit to the right of the decimal point in \\(0.12345678910111213\\dots\\)?", kw: "Champernowne constant digit" }
      ]},
      { title: "高级数论", leaves: [
        { t: "费马小定理 Fermat's Little Theorem", lv: "hard", ex: "By Fermat's Little Theorem, what is \\(2^{10} \\bmod 11\\)?", kw: "Fermat's Little Theorem" },
        { t: "欧拉定理 Euler's Theorem", lv: "hard", ex: "Euler's theorem says \\(a^{\\varphi(n)} \\equiv 1 \\pmod{n}\\) for coprime \\(a, n\\). What is \\(\\varphi(10)\\)?", kw: "Euler's totient theorem" },
        { t: "中国剩余定理 Chinese Remainder Theorem", lv: "hard", ex: "Find the smallest positive \\(x\\) with \\(x \\equiv 1 \\pmod{3}\\) and \\(x \\equiv 2 \\pmod{5}\\).", kw: "Chinese Remainder Theorem" },
        { t: "阶与原根 Order & Primitive Roots", lv: "hard", ex: "What is the order of \\(2\\) modulo \\(7\\) (the smallest \\(k\\) with \\(2^k \\equiv 1 \\pmod{7}\\))?", kw: "order modulo primitive root" }
      ]},
      { title: "解题技巧", leaves: [
        { t: "因式分解 Factoring (Integers)", lv: "mid", ex: "Factor \\(2x^2 - 8\\) completely.", kw: "factoring integers" },
        { t: "构造法 Construction Method", lv: "hard", ex: "Show there exists a positive integer leaving remainder \\(2 \\pmod 3\\) and \\(3 \\pmod 4\\); give one such number.", kw: "construction number theory" },
  ...
  },
  {
    ...
    branches: [
      { title: "计数原理", leaves: [
        ...
        { t: "组合 C(n,k) Combinations C(n,k)", lv: "mid", ex: "How many ways to choose \\(2\\) students from a group of \\(5\\)? \\(\\left(\\binom{5}{2} = \\,?\\right)\\)", kw: "combinations" },
      ...
      { title: "概率", leaves: [
        ...
        { t: "独立事件 Independent Events", lv: "mid", ex: "Two fair coins are flipped. What is the probability that both are heads? \\(\\left(\\tfrac12 \\times \\tfrac12 = \\,?\\right)\\)", kw: "independent events" },
        ...
        { t: "期望值 Expected Value", lv: "hard", ex: "A game pays $2 with probability \\(\\tfrac12\\) and $0 otherwise. What is the expected payoff?", kw: "expected value" }
      ]},
      { title: "组合技巧", leaves: [
        ...
        { t: "1-1 对应 Bijection (1–1 Correspondence)", lv: "hard", ex: "How many subsets does a 4-element set have? (Use the 1–1 correspondence with 4-bit strings: \\(2^4\\).)", kw: "bijection subsets" }
      ]},
      { title: "图论基础", leaves: [
        { t: "路径与连通 Paths & Connectivity", lv: "mid", ex: "In a \\(3\\times 3\\) grid of intersections, how many shortest paths go from bottom-left to top-right moving only up or right?", kw: "grid paths" },
